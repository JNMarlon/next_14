...
function NavMenuExplore() {
    const segment = useSelectedLayoutSegment() as NavSegment;
    ...
    return (
        <li>
            <Link href={Route.Explore}>
                <div className={style.navPill}>
                    {/*segment 조건 일치 여부*/}
                    {segment && [NavSegment.Search, NavSegment.Explore].includes(segment) ? (
                        <>
                            <svg
                                width={26}
                                viewBox="0 0 24 24"
